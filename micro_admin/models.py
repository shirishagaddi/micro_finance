...
class User(AbstractBaseUser):
	username = models.CharField(max_length=50, unique=True, required=True)
...
class Clients(models.Model):
    ...
    mobile = models.BigIntegerField()
    pincode = models.BigIntegerField()
    photo = models.ImageField(upload_to= 'static/images/usersprofiles/photos/')
    signature = models.ImageField(upload_to = 'static/images/usersprofiles/signatures/')
    is_active = models.BooleanField(default=True)
    branch = models.ForeignKey(Branch)
