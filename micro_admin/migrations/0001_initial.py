    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mobile', models.BigIntegerField()),
                ('pincode', models.BigIntegerField()),
                ('photo', models.ImageField(upload_to=b'/home/micropyramid/microfinance/microfinance/images/users')),
                ('signature', models.ImageField(upload_to=b'/home/micropyramid/microfinance/microfinance/images/signature')),
                ('is_active', models.BooleanField(default=True)),
                ('branch', models.ForeignKey(to='micro_admin.Branch')),
            ],
            options={
